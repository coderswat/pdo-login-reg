...
<nav class="bg-white shadow-md border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
  <div class="container flex flex-wrap justify-between items-center mx-auto">
    <a href="#" class="flex items-center">
        ...
        <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Login</span>
    </a>
...
<button type="submit" class="
    text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" name="submit">Login Now</button>
</form>
<p class="text-center mt-4 text-gray-500">Dont have an account ? <a href="register.php" class="text-blue-500">Register Now</a></p>
...
if(isset($_POST['submit'])){
  $login = new LoginContr($_POST['name'],$_POST['pass']);
  $login->loginUser();
  echo "Success";
  echo "<meta http-equiv='refresh' content=0.1;url='index.php'>";
}
